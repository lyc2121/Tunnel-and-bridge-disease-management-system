...
public class StepService extends Service {
    ...
    public void onCreate() {
       ...
       this.mSensorManager.registerListener(this.mStepDetector, this.mSensor, SensorManager.SENSOR_DELAY_GAME);
        ...
        //this.mBluetoothLeService.initListener(this.mStepCount);
    ...
    public void onDestroy() {
       ...
       // this.mSensorManager.unregisterListener(this.mBluetoothLeService);
